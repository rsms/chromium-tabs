...
- (BOOL)isValidURI
{
  ...
  return NO;*/
  DLOG("%s is not implemented and always return YES", __func__);
  return YES;
}
...
{
  NSString *unescapedURI = (__bridge_transfer NSString*)CFURLCreateStringByReplacingPercentEscapesUsingEncoding(kCFAllocatorDefault,
